...
import gsonfire.gson.*;
import gsonfire.postprocessors.MergeMapPostProcessor;
import gsonfire.postprocessors.methodinvoker.MethodInvokerPostProcessor;
import gsonfire.util.Mapper;
import gsonfire.util.reflection.CachedReflectionFactory;
...
public final class GsonFireBuilder {
    ...
    /**
     * By enabling this, all methods with the annotation {@link gsonfire.annotations.ExposeMethodResult} will
     ...
     * {@link gsonfire.annotations.ExcludeByValue} will be run to remove specific fields from the resulting json
     * @return
     */
     ...
     * annotated with {@link gsonfire.annotations.MergeMap}, the map will be walked and merged
     * with the resulting json object.
     *
     * This method has been deprecated and a {@link gsonfire.PostProcessor} should be used instead
     * @return
     */
    @Deprecated
